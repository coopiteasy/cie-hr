...
class HrEmployee(models.Model):
    ...
    attendance_state = fields.Selection(
        selection_add=[("break", "Break"), ("lunch", "Lunch")]
    )

    @api.depends(
        "last_attendance_id.work_type_id",
        ...
        for employee in self:
            ...
            if not att or att.check_out:
                ...
                employee.attendance_state = (
                    employee.last_attendance_id.work_type_id.attendance_state
                )
            else:
    ...
    def attendance_manual(self, next_action, entered_pin=None, work_type_id=None):
        ...
        if not entered_pin:
            ...
            entered_pin = None
        return super(HrEmployee, self).attendance_manual(
    ...
    def _attendance_action_change(self):
        ...
        if attendance:
            ...
            raise UserError(
                _(
                    "Cannot perform check out on %(empl_name)s, could not "
